...
require 'rackspace-fog/libvirt/models/compute/util/util'
require 'rackspace-fog/libvirt/models/compute/util/uri'
...
module Fog
  module Compute
    class Libvirt < Fog::Service
      ...
      model_path 'rackspace-fog/libvirt/models/compute'
      model       :server
      collection  :servers
      model       :network
      collection  :networks
      ...
      request_path 'rackspace-fog/libvirt/requests/compute'
