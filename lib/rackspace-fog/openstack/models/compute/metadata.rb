...
require 'rackspace-fog/openstack/models/meta_parent'
require 'rackspace-fog/openstack/models/compute/metadatum'
require 'rackspace-fog/openstack/models/compute/image'
require 'rackspace-fog/openstack/models/compute/server'
