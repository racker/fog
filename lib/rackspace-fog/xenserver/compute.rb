...
module Fog
  module Compute 
    class XenServer < Fog::Service
      ...
      require 'rackspace-fog/xenserver/utilities'
      require 'rackspace-fog/xenserver/parser'
      ...
      model_path 'rackspace-fog/xenserver/models/compute'
      model :server
      collection :servers
      model :host
      collection :hosts
      ...
      request_path 'rackspace-fog/xenserver/requests/compute'
