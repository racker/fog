module Fog
  module Storage
    ...
    def self.new(attributes)
      ...
      when :aws
        require 'rackspace-fog/aws/storage'
        Fog::Storage::AWS.new(attributes)
      when :google
        require 'rackspace-fog/google/storage'
        Fog::Storage::Google.new(attributes)
      when :hp
        require 'rackspace-fog/hp/storage'
        Fog::Storage::HP.new(attributes)
      when :ibm
        require 'rackspace-fog/ibm/storage'
        Fog::Storage::IBM.new(attributes)
      when :local
        require 'rackspace-fog/local/storage'
        Fog::Storage::Local.new(attributes)
      when :ninefold
        require 'rackspace-fog/ninefold/storage'
        Fog::Storage::Ninefold.new(attributes)
      when :rackspace
        require 'rackspace-fog/rackspace/storage'
